        ...
        <div class="panel-body">
            <div class="col-md-6 col-sm-12">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="{{ route('user.search',['term' =>$searchTerm]) }}" class="active">User</a></li>
                    <li><a href="{{ route('user.search.place',['term' =>$searchTerm]) }}">Place</a></li>
                    <li><a href="{{ route('user.search.field',['term' =>$searchTerm]) }}">Profession</a></li>
                </ul>
            </div>
            <div class="col-md-6 col-sm-12">
