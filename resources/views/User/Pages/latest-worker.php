        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-md-3 product-grid">
                ...
                <div class="thumbnail">
                    ...
                    <img class="w-8" src="{{ asset('images/profile/' . $user->profile_image) }}" alt="..." style="max-width: 100px; object-fit: fill;">
                    ...
                    <div class="caption">
                        ...
                        <h4>{{ $user->name }}</h4>
                        <p>{{ $user->email }}</p>
                        <p><a href="{{ route('user.contact.form', ['id' => $user->id]) }}" class="btn btn-info" role="button">Contact</a></p>
